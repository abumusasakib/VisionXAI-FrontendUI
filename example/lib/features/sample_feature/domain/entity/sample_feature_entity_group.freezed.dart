...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SampleFeatureEntityGroup);
}
...
@override
String toString() {
  return 'SampleFeatureEntityGroup()';
}
...
/// @nodoc
class $SampleFeatureEntityGroupCopyWith<$Res>  {
$SampleFeatureEntityGroupCopyWith(SampleFeatureEntityGroup _, $Res Function(SampleFeatureEntityGroup) __);
}


/// Adds pattern-matching-related methods to [SampleFeatureEntityGroup].
extension SampleFeatureEntityGroupPatterns on SampleFeatureEntityGroup {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( SampleFeatureEntity entity)?  success,TResult Function()?  unKnown,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Success() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( SampleFeatureEntity entity)  success,required TResult Function()  unKnown,}) {final _that = this;
switch (_that) {
case _Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( SampleFeatureEntity entity)?  success,TResult? Function()?  unKnown,}) {final _that = this;
switch (_that) {
case _Success() when success != null:
return success(_that.entity);case _Unknown() when unKnown != null:
return unKnown();case _:
...
class _Success implements SampleFeatureEntityGroup {
  const _Success(this.entity);
  

 final  SampleFeatureEntity entity;

/// Create a copy of SampleFeatureEntityGroup
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $SampleFeatureEntityGroupCopyWith<$Res> {
...
class _Unknown implements SampleFeatureEntityGroup {
  const _Unknown();
