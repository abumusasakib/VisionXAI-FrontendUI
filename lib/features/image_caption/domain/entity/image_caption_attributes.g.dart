...
_$ImageCaptionAttributesImpl _$$ImageCaptionAttributesImplFromJson(
...
Map<String, dynamic> _$$ImageCaptionAttributesImplToJson(
        _$ImageCaptionAttributesImpl instance) =>
    <String, dynamic>{
